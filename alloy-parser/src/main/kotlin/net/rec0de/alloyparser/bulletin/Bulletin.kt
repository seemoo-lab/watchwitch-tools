...
class Bulletin(
    ...
    fun renderProtobuf(): ByteArray {
        ...
        if(date != null)
            fields[0x07] = listOf(ProtoI64(date.toCanonicalTimestamp().longBytesFromDouble()))
        if(attachment != null)
            fields[0x08] = listOf(ProtoLen(attachment))
        if(action != null)
            fields[0x09] = listOf(ProtoLen(action.renderProtobuf()))
        if(feed != null)
            fields[0x0a] = listOf(ProtoVarInt(feed.toLong()))
        if(snoozeAction != null)
        ...
        if(sectionSubtype != null)
            fields[0x0f] = listOf(ProtoVarInt(sectionSubtype.toLong()))
        if(sockPuppetAppBundleID != null)
            fields[0x10] = listOf(ProtoString(sockPuppetAppBundleID))
        if(category != null)
            fields[0x11] = listOf(ProtoString(category))
        if(publicationDate != null)
            fields[0x12] = listOf(ProtoI64(publicationDate.toCanonicalTimestamp().longBytesFromDouble()))
        if(includesSound != null)
            fields[0x13] = listOf(ProtoVarInt(if(includesSound) 1 else 0))
        if(teamID != null)
        ...
        if(soundAlertType != null)
            fields[0x18] = listOf(ProtoVarInt(soundAlertType.toLong()))
        if(soundAccountIdentifier != null)
            fields[0x19] = listOf(ProtoString(soundAccountIdentifier))
        if(soundToneIdentifier != null)
            fields[0x1a] = listOf(ProtoString(soundToneIdentifier))
        if(attachmentType != null)
            fields[0x1b] = listOf(ProtoVarInt(attachmentType.toLong()))
        if(containsUpdatedAttachment != null)
            fields[0x1c] = listOf(ProtoVarInt(if(containsUpdatedAttachment) 1 else 0))
        if(loading != null)
            fields[0x1d] = listOf(ProtoVarInt(if(loading) 1 else 0))
        if(turnsOnDisplay != null)
            fields[0x1e] = listOf(ProtoVarInt(if(turnsOnDisplay) 1 else 0))
        ...
        if(ignoresQuietMode != null)
            fields[0x23] = listOf(ProtoVarInt(if(ignoresQuietMode) 1 else 0))
        if(categoryID != null)
        ...
        if(requiredExpirationDate != null)
            fields[0x2a] = listOf(ProtoI64(requiredExpirationDate.toCanonicalTimestamp().longBytesFromDouble()))
        if(replyToken != null)
            fields[0x2b] = listOf(ProtoString(replyToken))
        if(soundMaximumDuration != null)
            fields[0x2c] = listOf(ProtoI64(soundMaximumDuration.longBytesFromDouble()))
        if(soundShouldRepeat != null)
            fields[0x2d] = listOf(ProtoVarInt(if(soundShouldRepeat) 1 else 0))
        if(soundShouldIgnoreRingerSwitch != null)
            fields[0x2e] = listOf(ProtoVarInt(if(soundShouldIgnoreRingerSwitch) 1 else 0))
        if(hasCriticalIcon != null)
            fields[0x2f] = listOf(ProtoVarInt(if(hasCriticalIcon) 1 else 0))
        if(soundAudioVolume != null)
            fields[0x30] = listOf(ProtoI64(soundAudioVolume.longBytesFromDouble()))
        if(preemptsPresentedAlert != null)
            fields[0x31] = listOf(ProtoVarInt(if(preemptsPresentedAlert) 1 else 0))
        if(suppressDelayForwardBulletins != null)
            fields[0x32] = listOf(ProtoVarInt(if(suppressDelayForwardBulletins) 1 else 0))
        if(icon != null)
            fields[0x33] = listOf(ProtoLen(icon.renderProtobuf()))
        if(containsUpdateIcon != null)
            fields[0x34] = listOf(ProtoVarInt(if(containsUpdateIcon) 1 else 0))
